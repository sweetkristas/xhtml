...
namespace xhtml
{
	...
	public:
		...
		bool render(const KRE::SceneTreePtr& scene_tree, const Dimensions& dims) const;
		void renderNormal(const KRE::SceneTreePtr& scene_tree, const Dimensions& dims) const;
