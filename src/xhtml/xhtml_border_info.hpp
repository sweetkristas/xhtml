...
namespace xhtml
{
	...
	public:
		...
		bool render(const KRE::SceneTreePtr& scene_tree, const point& offset, const Dimensions& dims) const;
		void renderNormal(const KRE::SceneTreePtr& scene_tree, const point& offset, const Dimensions& dims) const;
