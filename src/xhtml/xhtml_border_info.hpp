...
namespace xhtml
{
	...
	public:
		...
		bool isValid(css::Side side) const { return (border_style_[static_cast<int>(side)] != css::CssBorderStyle::HIDDEN 
			&& border_style_[static_cast<int>(side)] != css::CssBorderStyle::NONE) || !uri_.isNone(); }
